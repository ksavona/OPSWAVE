  ...
  test: {
    coverage: {
      exclude: [
        ...
        "apps/web/src/components/compliance-review.tsx",
        "apps/web/src/components/delegate-workspace.tsx",
        "apps/web/src/components/delegations-workspace.tsx",
        "apps/web/src/components/intake-panel.tsx",
        "apps/web/src/components/invitation-acceptance.tsx",
        ...
        "apps/web/src/components/subject-delegations-panel.tsx",
        "apps/web/src/components/workspace.tsx",
        "apps/web/src/proxy.ts",
        "apps/web/src/server/activity-service.ts",
        "apps/web/src/server/authorization-service.ts",
        "apps/web/src/server/collaboration-document-handlers.ts",
        "apps/web/src/server/collaboration-handlers.ts",
        "apps/web/src/server/compliance-service.ts",
        "apps/web/src/server/current-session.ts",
        "apps/web/src/server/delegate-service.ts",
        "apps/web/src/server/delegation-service.ts",
        "apps/web/src/server/document-service.ts",
        "apps/web/src/server/http-handlers.ts",
        "apps/web/src/server/invitation-service.ts",
        "apps/web/src/server/notification-service.ts",
        "apps/web/src/server/rate-limits.ts",
        "apps/web/src/server/runtime.ts",
        "apps/web/src/server/timesheet-service.ts",
        "apps/web/src/server/work-service.ts",
        "packages/db/src/client.ts",
        "packages/db/src/collaboration-store.ts",
